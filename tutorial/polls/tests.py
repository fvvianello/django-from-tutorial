...
class QuestinIndexDetailTests(TestCase):

    def test_detail_view_with_a_future_question(self):
        """
        The dtail view of a question with a future pub_date should return
        404 not found
        """
    ...
    def test_detail_view_with_a_past_question(self):
        """
        The detail view of a question with a pub_date in the pas should display
        the question's text
        """
